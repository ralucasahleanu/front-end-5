...
var a = { x: 2 };
var b = { x: 2 };
console.log("a === b", a === b); // false pt ca a si b sunt 2 obiecte diferire (not primitives) care intamplator au valori identice
var n = 2, m = 2;
console.log("n === m", n === m); //true pt ca m si n sunt primitive
